...
const index = function inlineAttachment(options, instance) {
    this.settings = { ...index.defaults, ...options };
 ...
 */
index.prototype.uploadFile = function uploadFile(file) {
 ...
 */
index.prototype.isFileAllowed = function isFileAllowed(file) {
    if (file.kind === 'string') {
        return false;
    }
 ...
 * @return {Void}
 */
index.prototype.onFileUploadResponse = function onFileUploadResponse(xhr) {
 ...
 * @return {Void}
 */
index.prototype.onFileUploadError = function onFileUploadError(xhr) {
 ...
 * @return {Void}
 */
index.prototype.onFileInserted = function onFileInserted(file) {
 ...
 */
index.prototype.onPaste = function onPaste(e) {
    let result = false;
 ...
 * @return {Boolean} if the event was handled
 */
index.prototype.onDrop = function onDrop(e) {
    let result = false;
...
codeMirrorEditor.attach = function editorAttach(codeMirror, options = {}) {
    ...
    const inlineattach = new index(options, editor); // eslint-disable-line
...
index.editors.codemirror = codeMirrorEditor;
index.editors.codemirror4 = codeMirrorEditor4;
